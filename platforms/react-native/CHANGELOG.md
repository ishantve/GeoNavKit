...
### Added
- Initial npm release — TypeScript port of the Swift GeoNavKit API.
...
### Notes
- The version number tracks the Swift package it ports and shares its git tag,
  so the first npm release is 1.0.2 rather than 1.0.0.
